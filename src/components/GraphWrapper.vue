        ...
        // add sidebar elements
            addSidebarIcon: function (graph, sidebar, prototype) {
                ...
                {   
                    ...
                    ||(Object.values(evt.getProperty('cell').source.getValue(Object)).includes("Method"))
                    ...
                    &&(Object.values(evt.getProperty('cell').target.getValue(Object)).includes("Atributte"))
                    ||(Object.values(evt.getProperty('cell').target.getValue(Object)).includes("Method")))
                    {                                         
